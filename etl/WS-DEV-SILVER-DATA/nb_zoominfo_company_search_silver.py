#!/usr/bin/env python3
"""
ZoomInfo Company Search — Silver
Reads bronze Delta, deduplicates by company_id (latest ingested_at),
merges into silver Delta table.
Chains to nb_zoominfo_company_search_gold.py
"""
...
S3_RAW    = "s3a://goglo-bronze-layer/zoominfo/zoominfo-etl-company-search-raw"
...
spark = (
    ...
    .appName("zoominfo_company_search_silver")
...
# ---------------------------------------------------------------------------
# DEDUP — keep latest ingested_at per company_id
# ---------------------------------------------------------------------------
...
BUSINESS_COLS = [
    "company_name", "website", "ticker", "phone", "revenue",
    "employee_count", "company_type", "city", "state", "country",
    "continent", "street", "zip_code", "naics_code", "sic_code",
    "industry_keywords_json", "hashtags_json", "founded", "is_defunct",
