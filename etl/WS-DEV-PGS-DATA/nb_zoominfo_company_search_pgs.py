#!/usr/bin/env python3
"""
ZoomInfo Company Search — Postgres Load
Reads gold Delta, anti-joins against zoominfo.company_search in Postgres
on company_search_key, appends net-new rows via JDBC.
"""
...
PGS_TABLE    = "zoominfo.company_search"
...
spark = (
    ...
    .appName("zoominfo_company_search_pgs")
...
try:
    pgs_keys_df = (
        ...
        .jdbc(
            url=PGS_JDBC_URL,
            table=f"(SELECT company_search_key FROM {PGS_TABLE}) AS pgs_keys",
